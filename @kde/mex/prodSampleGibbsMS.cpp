            ...
            double *_randU, double* _randN)
{
  ...
  Nlevels = (unsigned int) (log((long double)maxNp)/log(2))+1;          // how many levels to a balanced binary tree?
            ...
            double *_randU, double* _randN)
{
  ...
  Nlevels = (unsigned int) (log((double)maxNp)/log(2))+1;          // how many levels to a balanced binary tree?
